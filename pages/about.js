      ...
      <main className="pt-24 md:pt-32 pb-24">
        ...
        <section className="max-w-3xl mx-auto px-4 sm:px-6 mb-16 md:mb-24">
          <div className="bg-slate-800/30 border border-white/5 rounded-3xl p-6 sm:p-10">
            ...
            <div className="space-y-4 text-slate-400 leading-relaxed">
              <p>
                Scrayva was founded in 2026 by a solo builder who got tired of spending hours on repetitive browser work—researching competitor prices, analyzing market trends on LinkedIn, manually checking if a product was back in stock. All tasks that were just waiting to be automated.
              </p>
              <p>
        ...
        <section className="max-w-2xl mx-auto px-4 sm:px-6 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=support@scrayva.space&su=General%20Inquiry" target="_blank" rel="noopener noreferrer" className="px-8 py-4 bg-white/5 hover:bg-white/10 border border-white/10 text-white rounded-xl font-bold transition-all">
              Say Hello 👋
            </a>
          </div>
        </section>
      ...
      <footer className="border-t border-white/5 py-10">
        <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row justify-between items-center gap-4 text-sm text-slate-500">
          ...
          <div className="flex gap-6">
            ...
            <a className="hover:text-white transition-colors" href="https://mail.google.com/mail/?view=cm&fs=1&to=support@scrayva.space&su=Contact%20Support" target="_blank" rel="noopener noreferrer">Contact</a>
          </div>
        </div>
      </footer>
    </div>
