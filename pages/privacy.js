      ...
      <main className="pt-28 pb-24 max-w-3xl mx-auto px-6">
        ...
        <div className="mb-12">
          ...
          <p className="text-slate-400 mt-2">
            ...
            <a href="https://mail.google.com/mail/?view=cm&fs=1&to=support@scrayva.space&su=Privacy%20Inquiry" target="_blank" rel="noopener noreferrer" className="text-brand-accent hover:underline">support@scrayva.space</a>.
          </p>
        </div>
