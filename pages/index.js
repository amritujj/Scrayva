          ...
          <div data-reveal="scale"
            ...
            <div className="relative z-10 max-w-2xl">
              ...
              <div data-reveal="left" data-delay="450" className="flex flex-wrap items-center gap-4">
                <a href="mailto:support@scrayva.com?subject=Scrayva%20Voice%20Waitlist&body=Hi%2C%20I%20want%20to%20join%20the%20Scrayva%20Voice%20waitlist!" className="px-8 py-3 bg-white text-slate-900 rounded-full font-bold hover:bg-slate-200 transition-colors">
                  Join the Waitlist
                </a>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-12 mb-16">
            ...
            <div data-reveal data-delay="200">
              ...
              <ul className="text-slate-500 space-y-4 text-sm">
                ...
                <li><a className="hover:text-brand-primary transition-colors" href="mailto:support@scrayva.com">Contact</a></li>
